...
void ICON_Pause() {
  if (select_print.now == 1) {
      ...
      {
          DWIN_Frame_AreaCopy(1,228,142,268,160,118,356);
      }
  }
  else {
        ...
        {
            DWIN_Frame_AreaCopy(1,166,100,206,118,118,356);
        }
  }
}
...
inline void Draw_Prepare_Menu() {
  ...
  if (HMI_flag.language_flag) {
      DWIN_Frame_AreaCopy(1,87,0,115,20,122,5); //设置             
    if (CVISI(1)) 
    {
   ...
   if (CVISI(3))
   {
      ...
      {
          DWIN_ICON_Show(ICON2,55,LBLX,CLINE(3)+3);
      } 
      if(filament_flag==false)
      {
          DWIN_ICON_Show(ICON2,25,200,CLINE(3));
...
void Draw_Print_ProgressRemain() {
 ...
 if (HMI_flag.language_flag)
 {
  ...
  {
    DWIN_Frame_AreaCopy(1,124,182,210,202,160,241);
  }
...
void Goto_MainMenu(void) {
  ...
  if (HMI_flag.language_flag) {
     DWIN_Frame_AreaCopy(1, 0, 0,28 ,20 , 122, 5); // "Home"
  }
  else {
    #ifdef USE_STRING_HEADINGS
...
inline void Redraw_SD_List() {
  ...
  Draw_Steady_State();
  if (HMI_flag.language_flag) {
      DWIN_Frame_AreaCopy(1, 144, 0, 200, 20, 110, 5);
  }
  else {
    #ifdef USE_STRING_HEADINGS
      ...
      // DWIN_Frame_AreaCopy(1,110,50,136,68,265+32+8,12);
       DWIN_Frame_AreaCopy(1, 0, 20, 87, 40, 100, 5); // "Print file"
    #endif
  }
  //  if (HMI_flag.language_flag) {
...
inline void Draw_Info_Menu() {
  Clear_Main_Window();
  Draw_Steady_State();
  DWIN_Draw_String(false, false, font8x16, Black, White, (DWIN_WIDTH - 35 * MENU_CHR_W) , 144, (char*)"Voxelab Aquila X3");
  DWIN_Draw_String(false, false, font8x16, Black, White, (DWIN_WIDTH - 27 * MENU_CHR_W) , 188, (char*)"220*220*250mm");
  DWIN_Draw_String(false, false, font8x16, Black, White, (DWIN_WIDTH - 11 * MENU_CHR_W) , 232, (char*)SHORT_BUILD_VERSION);
  DWIN_Draw_String(false, false, font8x16, Black, White, (DWIN_WIDTH - 37 * MENU_CHR_W) , 276, (char*)"www.voxelab3dp.com");
  DWIN_Draw_String(false, false, font8x16, Black, White, (DWIN_WIDTH - 41 * MENU_CHR_W) , 320, (char*)"sales@voxelab3dp.com");
...
inline void Draw_Print_File_Menu() {
  ...
  if (HMI_flag.language_flag) {
    DWIN_Frame_AreaCopy(1, 145, 0, 201, 20, 110,5);
  }
  else {
    #ifdef USE_STRING_HEADINGS
      Draw_Title("Print file"); // TODO: GET_TEXT_F
    #else
      DWIN_Frame_AreaCopy(1, 0, 20, 87, 40, 80,5); // "Print file"
    #endif
  }
  Redraw_SD_List();
...
void Draw_matic_Menu(){
      ...
      if(HMI_flag.language_flag){
        ...
        DWIN_ICON_Show(ICON2,78,110,5);
        }
        else
        {
          //  DWIN_Frame_AreaCopy(1,0,180,56,200,285, 12);
           DWIN_ICON_Show(ICON2,79,110,5);
        }
      ...
      else
      {
        if(checkkey==Feeding)
        {
            // DWIN_Frame_AreaCopy(1,0,205,115,220,250, 12);
             DWIN_ICON_Show(ICON2,76,80,5);
        } 
        else
        {
          // DWIN_Frame_AreaCopy(1,120,205,255,220,240,12);
           DWIN_ICON_Show(ICON2,77,80,5);
        }
  ...
  if (encoder_diffState == ENCODER_DIFF_CW) {
    ...
    switch (select_control.now) {
      ...
      case 8: 
        ...
        Draw_matic_Menu();
        if(HMI_flag.language_flag)
        DWIN_ICON_Show(ICON2,39,35,170);
        else
...
void Draw_Temperature_Menu() {
  ...
  if (HMI_flag.language_flag) {
    ...
    #else
     DWIN_Frame_AreaCopy(1,0,40,85,60,100,5);
    #endif
        ...
        break;
          ...
          case 4: // PLA preheat setting
            ...
            if (HMI_flag.language_flag) {
              ...
              #else
              {
                DWIN_Frame_AreaCopy(1,135,40,272,60,80,5);
          ...
          case 5: // ABS preheat setting
            ...
            if (HMI_flag.language_flag) {
              ...
              #else
                //DWIN_Frame_AreaCopy(1, 56, 16, 271 - 130, 479 - 450 - 1, 14, 8);
                  DWIN_Frame_AreaCopy(1, 0, 60, 137, 80, 80, 5);
...
inline void Draw_Max_Speed_Menu() {
  ...
  if (HMI_flag.language_flag) {
    DWIN_Frame_AreaCopy(1, 115, 40, 172, 60, 108, 5);     // max speed
    ...
    #else
    DWIN_Frame_AreaCopy(1, 188, 60, 261, 80, 100, 5);   // "Max"                                              // "Max speed"                     
    #endif
...
inline void Draw_Max_Accel_Menu() {
  ...
  if (HMI_flag.language_flag) {
    ...
    DWIN_Frame_AreaCopy(1,173,40,250,60,102,5);
    ...
    #else
      DWIN_Frame_AreaCopy(1, 0, 80, 114, 100, 90, 5);   // "Max"
...
inline void Draw_Max_Jerk_Menu() {
  ...
  if (HMI_flag.language_flag) {
      ...
      DWIN_Frame_AreaCopy(1, 0, 60, 83, 78, 95, 5);     // max...
     ...
     // DWIN_Frame_AreaCopy(1, 144, 16, 271 - 82, 479 - 453, 14, 8);
       DWIN_Frame_AreaCopy(1, 116, 80, 192, 100, 100, 5);   // "Max"
...
inline void Draw_Steps_Menu() {
  ...
  if (HMI_flag.language_flag) {
    ...
    #else
      //DWIN_Frame_AreaCopy(1, 144, 16, 271 - 82, 479 - 453, 14, 8);
       DWIN_Frame_AreaCopy(1, 0, 100, 97, 120, 90, 5);   // "Steps-per-mm"
    #endif
...
void DWIN_CompletedMaticHate(void)
{
      if(checkkey==Feeding) 
      {
        if(HMI_flag.language_flag)
        {
          ...
          delay(2);
          // DWIN_ICON_Show(ICON2,11,20,250);
          // delay(2);
					// DWIN_ICON_Show(ICON2,12,50,240);
            DWIN_ICON_Show(ICON2,41,35,160); 
        }
        else
        {
          DWIN_Draw_Rectangle(1, Background_black,  0,  160, 272,  380);
...
void DWIN_CompletedLeveling(void) {
  ...
  {
      DWIN_ICON_Show(ICON2,108,60,180);
  }
